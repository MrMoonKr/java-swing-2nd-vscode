...
public class ToolbarFrame3 extends Frame {
    ...
    public ToolbarFrame3() {
        ...
        URL cutURL = ToolbarFrame3.class.getClassLoader().getResource( "icons/cut.gif" );
        cutButton = new JButton( new ImageIcon( cutURL ) );
        ...
        URL copyURL = ToolbarFrame3.class.getClassLoader().getResource( "icons/copy.gif" );
        copyButton = new JButton( new ImageIcon( copyURL ) );
        ...
        URL pasteURL = ToolbarFrame3.class.getClassLoader().getResource( "icons/paste.gif" );
        pasteButton = new JButton( new ImageIcon( pasteURL ) );
