...
public class ActionExample extends JPanel {
    ...
    public ActionExample() {
        ...
        URL actionURL = ActionExample.class.getClassLoader().getResource( "icons/action.gif" );
        SampleAction exampleAction = new SampleAction( "Download", new ImageIcon( actionURL ) );
